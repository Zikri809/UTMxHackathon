...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-6 overflow-hidden rounded-lg border border-border/80 bg-card/96 py-6 text-sm text-card-foreground shadow-[0_1px_0_oklch(1_0_0_/_0.72)_inset,0_12px_32px_oklch(0.24_0.04_110_/_0.06)] ring-1 ring-foreground/5 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
        className
      )}
      {...props}
    />
